        ...
        <div class="flex justify-between h-16">
          ...
          <div class="flex">
            ...
            <nav class="hidden md:ml-8 md:flex md:space-x-8">
              ...
              <router-link
                to="/requests"
                class="inline-flex items-center px-1 pt-1 text-sm font-medium transition-colors"
                :class="isActiveRoute('/requests') ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-gray-700'"
              >
              ...
              <router-link
                to="/reports"
                class="inline-flex items-center px-1 pt-1 text-sm font-medium transition-colors"
                :class="isActiveRoute('/reports') ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-gray-700'"
              >
          ...
          <div class="flex items-center space-x-4">
            ...
            <Button variant="ghost" size="sm" class="relative">
              <Bell class="h-5 w-5" />
              <span v-if="unreadNotifications > 0" class="absolute -top-1 -right-1 h-3 w-3 bg-red-500 rounded-full"></span>
            </Button>
